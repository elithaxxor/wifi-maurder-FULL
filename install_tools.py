...
def install_linux_tools():
    ...
    commands = [
        ...
        ("sudo apt-get install -y hcxdumptool hcxpcapngtool", "Failed to install hcxdumptool"),
        ("sudo apt-get install -y hashcat", "Failed to install hashcat"),
        ("sudo apt-get install -y bettercap", "Failed to install bettercap"),
        ("sudo apt-get install -y dnsmasq hostapd-mana", "Failed to install hostapd-mana"),
        ("sudo apt-get install -y wifite", "Failed to install wifite"),
        ("sudo apt-get install -y airgraph-ng", "Failed to install airgraph-ng"),
        ("sudo apt-get install -y zeek", "Failed to install zeek"),
...
def install_macos_tools():
    ...
    commands = [
        ...
        ("brew install hcxdumptool hcxpcapngtool", "Failed to install hcxdumptool"),
        ("brew install hashcat", "Failed to install hashcat"),
        ("brew install bettercap", "Failed to install bettercap"),
        ("brew install hostapd-mana dnsmasq", "Failed to install hostapd-mana"),
        ("brew install wifite", "Failed to install wifite"),
        ("brew install airgraph-ng", "Failed to install airgraph-ng"),
        ("brew install zeek", "Failed to install zeek"),
